...
<EuiAccordion
      ...
      buttonContent={AccordinanIconButton("Elasticsearch", "logoElasticsearch")}
      paddingSize="m">
        <EuiButton
            iconSide="right"
        ...
        { this.state.data.Nodes.map((item, index) => {
            return (
              <EuiFlexItem key={index}>
                  <ElasticInstance data={item} remove={this.removeNode} onConfigChange={this.onNodeConfigChange}/>
              </EuiFlexItem>
            )})}
        </EuiFlexGrid>
        <EuiSpacer/>
        ...
        <EuiAccordion  id="accordion1"  buttonContent="Add Elasitic Secrets">
          <EuiSpacer/>
          <EuiButton onClick={ () => this.newSecret() }> Add Elasticsearch Secret </EuiButton>
          <EuiSpacer/>
...
<EuiFlexGroup>
  ...
  <EuiFormRow fullWidth>
    <EuiFieldText fullWidth placeholder="secret name" name="name" value={input.Name} onChange={(e) => this.onSecretChange(e, idx)}/>
  </EuiFormRow>
  </EuiFlexItem>
  <EuiFlexItem fullWidth>
  <EuiFormRow  fullWidth>
    <EuiFieldText fullWidth placeholder="secret value" name="value" value={input.Value} onChange={(e) => this.onSecretChange(e, idx)}/>
  </EuiFormRow>
  </EuiFlexItem>
