...
<EuiFormRow
    ...
    fullWidth>
    <EuiFieldNumber fullWidth name="InstanceCount" min={1} max={10} value={this.state.data.InstanceCount} onChange={this.onTextChange}  />
  </EuiFormRow>
  <EuiSpacer/>
  ...
  <EuiFlexGroup>
        <EuiFlexItem >
          <EuiFormRow fullWidth label="Cpu">
            <EuiFieldNumber fullWidth name="Cpu" min={0.5} step={0.25} max={10} value={this.state.data.Cpu} onChange={this.onTextChange}  />
          </EuiFormRow>
        </EuiFlexItem>
        <EuiFlexItem>
          <EuiFormRow fullWidth label="Memory">
          <EuiFieldNumber fullWidth name="Memory" min={1} max={8} value={this.state.data.Memory} onChange={this.onTextChange}  />
          </EuiFormRow>
        </EuiFlexItem>
      </EuiFlexGroup>
</EuiFormRow>
        ...
        <EuiSpacer/>
<EuiAccordion  id="accordionKibana"  buttonContent="Add Extra Kibana Config">
  <EuiSpacer/>
