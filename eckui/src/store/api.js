...
export default class eckAPI {
  ...
  getProjectQuota = (projectId) => {
    return axios.get(
      this.url + "/project/" + projectId + "/quota",
      this.createConfig()
    );
  };
  ...
  getProjectEvents = (projectId) => {
    return axios.get(
      this.url + "/project/" + projectId + "/events",
      this.createConfig()
    );
  };
  ...
  getDeployment = (projectId, id) => {
    return axios.get(
      this.url + "/project/" + projectId + "/deployments/" + id,
      this.createConfig()
    );
  };
  ...
  getDeploymentStatus = (projectId, id) => {
    return axios.get(
      this.url + "/project/" + projectId + "/deployments/" + id + "/status",
      this.createConfig()
    );
  };
  getDeploymentEvents = (projectId, id) => {
    return axios.get(
      this.url + "/project/" + projectId + "/deployments/" + id + "/events",
      this.createConfig()
    );
  };
  ...
  getDeploymentSecrets = (projectId, id) => {
    return axios.get(
      this.url + "/project/" + projectId + "/deployments/" + id + "/secrets",
      this.createConfig()
    );
  };
  ...
  getDeploymentKibana = (projectId, id) => {
    return axios.get(
      this.url + "/project/" + projectId + "/deployments/" + id + "/kibana",
      this.createConfig()
    );
  };
  ...
  getDeployments = (projectId) => {
    return axios.get(
      this.url + "/project/" + projectId + "/deployments",
      this.createConfig()
    );
  };
  ...
  createDeployments = (projectId, deployment) => {
    return axios.put(
      this.url + "/project/" + projectId + "/deployment",
      deployment,
      this.createConfig()
    );
  };
  ...
  getMetics = (projectId) => {
    return axios.get(
      this.url + "/project/" + projectId + "/metrics",
      this.createConfig()
    );
  };
